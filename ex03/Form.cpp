...
/*   Updated: 2022/04/03 16:21:49 by minsunki         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const Form &f)
	: _name(f.getName()), _signed(f.getSigned()), _reqSign(f.getReqSign()),
...
{
	return (o << "Form Type: " << f.formType() << ", target: "
	<< f.getName() << ", required grade to sign: "
